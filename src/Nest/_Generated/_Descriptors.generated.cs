...
///<param name="repository"> this parameter is required</param>
	...
	{ 
		...
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public CountDescriptor<T> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));
...
///<param name="index"> this parameter is required</param>
		...
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> Explain(bool explain = true) => AssignParam(p=>p.Explain(explain));

		///<summary>A comma-separated list of stored fields to return as part of a hit</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> StoredFields(params string[] stored_fields) => AssignParam(p=>p.StoredFields(stored_fields));
		...
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> DocvalueFields(params string[] docvalue_fields) => AssignParam(p=>p.DocvalueFields(docvalue_fields));
		...
		///<summary>Specify whether query terms should be lowercased</summary>
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public DeleteByQueryDescriptor<T> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));

		///<summary>Specify which field to use for suggestions</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> SuggestField(string suggest_field) => AssignParam(p=>p.SuggestField(suggest_field));
		...
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> SuggestMode(SuggestMode suggest_mode) => AssignParam(p=>p.SuggestMode(suggest_mode));

		///<summary>How many suggestions to return in response</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> SuggestSize(long suggest_size) => AssignParam(p=>p.SuggestSize(suggest_size));

		///<summary>The source text for which the suggestions should be returned</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> SuggestText(string suggest_text) => AssignParam(p=>p.SuggestText(suggest_text));

		///<summary>Whether to calculate and return scores even if they are not used for sorting</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public DeleteByQueryDescriptor<T> TrackScores(bool track_scores = true) => AssignParam(p=>p.TrackScores(track_scores));
...
///<param name="document"> describes an elasticsearch document of type <typeparamref name="TDocument"/> from which the index, type and id can be inferred</param>
		...
		///<summary>Specify whether query terms should be lowercased</summary>
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public ExplainDescriptor<TDocument> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));
...
///<param name="target"> this parameter is required</param>
	...
	{ 
		...
		///<summary>Specify whether query terms should be lowercased</summary>
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public ValidateQueryDescriptor<T> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));
...
///<param name="id"> this parameter is required</param>
	...
	{ 
		...
		///<summary>Specify whether query terms should be lowercased</summary>
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public SearchDescriptor<T> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));
...
///<param name="index"> this parameter is required</param>
		...
		///<summary>Specify whether to return detailed information about score computation as part of a hit</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> Explain(bool explain = true) => AssignParam(p=>p.Explain(explain));

		///<summary>A comma-separated list of stored fields to return as part of a hit</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> StoredFields(params string[] stored_fields) => AssignParam(p=>p.StoredFields(stored_fields));
		...
		///<summary>A comma-separated list of fields to return as the docvalue representation of a field for each hit</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> DocvalueFields(params string[] docvalue_fields) => AssignParam(p=>p.DocvalueFields(docvalue_fields));
		...
		///<summary>Specify whether query terms should be lowercased</summary>
		[Obsolete("Scheduled to be removed in 6.0, removed in Elasticsearch 5.1.1")]		public UpdateByQueryDescriptor<T> LowercaseExpandedTerms(bool lowercase_expanded_terms = true) => AssignParam(p=>p.LowercaseExpandedTerms(lowercase_expanded_terms));

		///<summary>Specify which field to use for suggestions</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> SuggestField(string suggest_field) => AssignParam(p=>p.SuggestField(suggest_field));
		...
		///<summary>Specify suggest mode</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> SuggestMode(SuggestMode suggest_mode) => AssignParam(p=>p.SuggestMode(suggest_mode));

		///<summary>How many suggestions to return in response</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> SuggestSize(long suggest_size) => AssignParam(p=>p.SuggestSize(suggest_size));

		///<summary>The source text for which the suggestions should be returned</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> SuggestText(string suggest_text) => AssignParam(p=>p.SuggestText(suggest_text));

		///<summary>Whether to calculate and return scores even if they are not used for sorting</summary>
		[Obsolete("Scheduled to be removed in 6.0, Bad client mapping, never available on this endpoint")]		public UpdateByQueryDescriptor<T> TrackScores(bool track_scores = true) => AssignParam(p=>p.TrackScores(track_scores));
