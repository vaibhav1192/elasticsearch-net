...
namespace Nest
{
	public partial interface IElasticClient
	{
		...
		/// </summary>
		ICloseJobResponse CloseJob(Id id, Func<CloseJobDescriptor, ICloseJobRequest> selector = null);

		/// <inheritdoc/>
		ICloseJobResponse CloseJob(ICloseJobRequest request);

		/// <inheritdoc/>
		Task<ICloseJobResponse> CloseJobAsync(Id id, Func<CloseJobDescriptor, ICloseJobRequest> selector = null, CancellationToken cancellationToken = default(CancellationToken));
	...
	{
		/// <inheritdoc/>
		public ICloseJobResponse CloseJob(Id id, Func<CloseJobDescriptor, ICloseJobRequest> selector = null) =>
			this.CloseJob(selector.InvokeOrDefault(new CloseJobDescriptor(id)));
		...
		/// <inheritdoc/>
		public Task<ICloseJobResponse> CloseJobAsync(Id id, Func<CloseJobDescriptor, ICloseJobRequest> selector = null, CancellationToken cancellationToken = default(CancellationToken)) =>
			this.CloseJobAsync(selector.InvokeOrDefault(new CloseJobDescriptor(id)), cancellationToken);
